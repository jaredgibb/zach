...
const heroBlockSchema = z.object({
      ...
      data: z.object({
            ...
            backgroundImageUrl: z.string().trim().max(2048).default(''),
            backgroundImageAlt: z.string().trim().max(300).default(''),
            overlayOpacity: z.coerce.number().min(0).max(0.95).default(0.55),
